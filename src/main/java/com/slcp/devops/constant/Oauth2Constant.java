...
public class Oauth2Constant {
	...
	public static final String SIGN_KEY = "DEVOPS";

	public static final String CAPTCHA_KEY = "devops.captcha.";

	public static final String SMS_CODE_KEY = "devops.sms.code.";
	...
	public static final String HEADER_TOKEN = "DevOps-Auth";

	/**
	 * 自定义client表名
	 */
	public static final String CLIENT_TABLE = "devops_sys_client";

	public static final String ENCRYPT = "{devops}";
	 ...
	 * 权限标识前缀
	 */
	public static final String DEVOPS_PERMISSION_PREFIX = "devops.permission.";

	/**
	 * 字段描述开始：用户ID
	 */
	public static final String DEVOPS_USER_ID = "userId";

	/**
	 * 用户名
	 */
	public static final String DEVOPS_USER_NAME = "userName";

	/**
	 * 用户头像
	 */
	public static final String DEVOPS_AVATAR = "avatar";

	/**
	 * 用户权限ID
	 */
	public static final String DEVOPS_ROLE_ID = "roleId";

	/**
	 * 用户类型
	 */
	public static final String DEVOPS_TYPE = "type";

	/**
	 * 租户ID
	 */
	public static final String DEVOPS_TENANT_ID = "tenantId";
